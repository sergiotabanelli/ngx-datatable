...
import { DATATABLE_CELL_CONTEXT, DATATABLE_HEADER_CELL_CONTEXT } from '../../src';

@Component({
  selector: 'my-cell',
  template: `
    <img
      *ngIf="cellCtx.value === 'male'"
      width="150"
      src="https://media.giphy.com/media/I8nepxWwlEuqI/giphy.gif"
    />
    <img
      *ngIf="cellCtx.value === 'female'"
      width="150"
...
@Component({
  selector: 'my-header',
  template: `
  <strong>Fancy</strong>: {{ headerCtx.column.name }} !!
  `
})
