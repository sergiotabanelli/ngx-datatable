import { Component, OnInit, TemplateRef, ViewChild, Inject, Host, forwardRef } from '@angular/core';
import { DATATABLE_CELL_CONTEXT } from 'projects/swimlane/ngx-datatable/src/public-api';

@Component({
  selector: 'my-summary',
  template: `
    <div class="name-container">
      <div class="chip" *ngFor="let name of cellCtx.column.customContext.parent.getNames()">
