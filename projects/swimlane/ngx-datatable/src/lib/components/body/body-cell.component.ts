 ...
 */
export const DATATABLE_CELL_CONTEXT = new InjectionToken<any>('datatable-cell-context');
  ...
  template: `
    <div class="datatable-body-cell-label" [style.margin-left.px]="calcLeftMargin(column, row)">
      ...
      <ng-container *ngIf="column.isTreeColumn">
        <button
          *ngIf="!column.treeToggleTemplate && !column.treeToggleComponent"
      ...
      <span *ngIf="!column.cellTemplate && !column.cellComponent" [title]="sanitizedValue" [innerHTML]="value"> </span>
      <ng-template
        #cellTemplate
...
export class DataTableBodyCellComponent implements DoCheck, OnDestroy, OnInit {
  ...
  ngOnInit(): void {
    const customProviders =
      !!this.column.customContext && !!this.column.customContext.cellProviders
        ? this.column.customContext.cellProviders
        : [];
    this.cellContexInjector = Injector.create({
      providers: [{ provide: DATATABLE_CELL_CONTEXT, useValue: this.cellContext }, ...customProviders],
